...
class PrikazovanjeStrani:
    ...
    def statistika(uporabnisko_ime, uporabnik):
        ...
        mozni_razpleti = ["zmage", "porazi", "remiji", "zmage_beli",
                          "porazi_beli", "remiji_beli", "zmage_crni", "porazi_crni", "remiji_crni"]
        ...
        slovar_rezultatov_s_podatki = {
            i: pridobi_podatek_o_odstotkih(i) for i in slovar_rezultatov}
