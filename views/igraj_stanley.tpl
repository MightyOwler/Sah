...
%if bottle.request.get_cookie('beli', secret=SKRIVNOST) is None and bottle.request.get_cookie('crni', secret=SKRIVNOST) is None:
<h1>Izberi barvo</h1>
...
<script type="module" src="../../static/sah_proti_stanleyu.js"></script>
</head>
<body>
