...
function updateStatus () {
  ...
  if (moveColor == "Black") {alert("Več sreče prihodnjič! Igra se bo shranila!"); var rezulat_na_koncu_pgn = " 1-0"}
  else {alert("Zmaga!!! Igra se bo shranila!"); var rezulat_na_koncu_pgn = " 0-1"}
